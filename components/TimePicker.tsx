...
export class Timepicker<P> extends React.Component<TimepickerProps & P, State> {
  ...
  private renderInputDefault = (props: Partial<TimepickerProps>, evaStyle: any): React.ReactElement => {
    return (
      <TouchableWithoutFeedback
        {...props}
  ...
  private renderInputIOS = (props: Partial<TimepickerProps>, evaStyle: any): React.ReactElement => {
    return (
      <Popover
  ...
  private renderInput = (props: Partial<TimepickerProps>, evaStyle: any): React.ReactElement => {
